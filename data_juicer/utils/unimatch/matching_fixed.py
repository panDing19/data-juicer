...
def local_correlation_softmax(
    ...
    # Make sure feature1 and sample_coords_norm are contiguous before grid_sample
    feature1_contiguous = feature1.contiguous()
    sample_coords_norm_contiguous = sample_coords_norm.contiguous()
    
    window_feature = F.grid_sample(
        feature1_contiguous, 
        sample_coords_norm_contiguous, 
